...
export default class DefinitionAdapter {
  ...
  //
  // * `connection` A {LanguageClientConnection} to the language server that will provide the definitions and highlights.
  ...
  async getDefinition(
    ...
    return {
      ...
      definitions: DefinitionAdapter.convertLocationsToDefinitions(definitions)
    };
  }

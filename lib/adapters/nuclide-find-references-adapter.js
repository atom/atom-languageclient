...
export default class NuclideFindReferencesAdapter {
  ...
  static getReferencedSymbolName(editor: atom$TextEditor, point: atom$Point, references: Array<Location>): string {
    const currentReference = references.find(r => Check.pointInRange(point, r.range)) || references[0];

...
export default class AutoLanguageClient {
  ...
  getSuggestions(request: any): Promise<Array<atom$AutocompleteSuggestion>> {
    return this.autoComplete != null ? this.autoComplete.getSuggestions(this._lc, request) : Promise.resolve([]);
  }
  ...
  getDefinition(editor: TextEditor, point: atom$Point): Promise<?nuclide$DefinitionQueryResult> {
    return this.definitions != null ? this.definitions.getDefinition(this._lc, editor, point) : Promise.resolve(null);
  }
  ...
  getOutline(editor: atom$TextEditor): Promise<?nuclide$Outline> {
    return this.outlineView != null ? this.outlineView.getOutline(this._lc, editor) : Promise.resolve(null);
  }
  ...
  getReferences(editor: atom$TextEditor, point: atom$Point): Promise<?nuclide$FindReferencesReturn> {
    return this.findReferences != null
      ? this.findReferences.getReferences(this._lc, editor, point, this.getProjectRoot())
  ...
  getHyperclickSuggestion(editor: atom$TextEditor, point: atom$Point): Promise<?nuclide$HyperclickSuggestion> {
    return this.hyperclick != null ? this.hyperclick.getSuggestion(this._lc, editor, point) : Promise.resolve(null);
  }
}

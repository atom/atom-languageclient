...
export class LanguageClientConnection {
  ...
  constructor(rpc: rpc.connection, logger: ?Logger) {
    ...
    rpc.onError(error => this._log.error(['rpc.onError', error]));
    rpc.onUnhandledNotification(notification => {
    ...
    rpc.onNotification(() => this._log.debug('rpc.onNotification', arguments));

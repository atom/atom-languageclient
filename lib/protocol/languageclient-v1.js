...
export class LanguageClientV1 {
  ...
  async completion(params: TextDocumentPosition): Promise<Array<CompletionItem>> {
  ...
  async hover(params: TextDocumentPosition): Promise<Hover> {
    return this._sendRequest('textDocument/hover', params);
  }

  async signatureHelp(params: TextDocumentPosition): Promise<SignatureHelp> {
    return this._sendRequest('textDocument/signatureHelp', params);
  }

  async gotoDefinition(params: TextDocumentPosition): Promise<Location | Array<Location>> {
    return this._sendRequest('textDocument/definition', params);
  }

  async findReferences(params: TextDocumentPosition): Promise<Array<Location>> {
    return this._sendRequest('textDocument/references', params);
  }

  async documentHighlight(params: TextDocumentPosition): Promise<Array<DocumentHighlight>> {
    return this._sendRequest('textDocument/documentHighlight', params);
  }

  async documentSymbol(params: TextDocumentIdentifier): Promise<Array<SymbolInformation>> {
...
export type ReferenceParams = TextDocumentPosition & {

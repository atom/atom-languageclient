...
export class LanguageClientV2 {
  _con: rpc.connection;
  _log: (m: mixed) => void;

  constructor(connection: rpc.connection, logger: (m: mixed) => void) {
  ...
  async completion(params: TextDocumentPositionParams): Promise<Array<CompletionItem> | CompletionList> {
    return this._sendRequest('textDocument/completion', params);
  }

  async completionItemResolve(params: CompletionItem): Promise<CompletionItem> {
  ...
  async signatureHelp(params: TextDocumentPositionParams): Promise<SignatureHelp> {
    return this._sendRequest('textDocument/signatureHelp', params);
  }

  async gotoDefinition(params: TextDocumentPositionParams): Promise<Location | Array<Location>> {
    return this._sendRequest('textDocument/definition', params);
  }

  async findReferences(params: TextDocumentPositionParams): Promise<Array<Location>> {
    return this._sendRequest('textDocument/references', params);
  }

  async documentHighlight(params: TextDocumentPositionParams): Promise<Array<DocumentHighlight>> {
    return this._sendRequest('textDocument/documentHighlight', params);
  }

  async documentSymbol(params: DocumentSymbolParams): Promise<Array<SymbolInformation>> {
    return this._sendRequest('textDocument/documentSymbol', params);
  }

  async workspaceSymbol(params: WorkspaceSymbolParams): Promise<Array<SymbolInformation>> {
    return this._sendRequest('workspace/symbol', params);
  }

  async codeAction(params: CodeActionParams): Promise<Array<Command>> {
    return this._sendRequest('textDocument/codeAction', params);
  }

  async codeLens(params: CodeLensParams): Promise<Array<CodeLens>> {
    return this._sendRequest('textDocument/codeLens', params);
  }

  async codeLensResolve(params: CodeLens): Promise<Array<CodeLens>> {
    return this._sendRequest('codeLens/resolve', params);
  }

  async documentLink(params: DocumentLinkParams): Promise<Array<DocumentLink>> {
    return this._sendRequest('textDocument/documentLink', params);
  }

  async documentLinkResolve(params: DocumentLink): Promise<DocumentLink> {
    return this._sendRequest('documentLink/resolve', params);
  }

  async documentFormatting(params: DocumentFormattingParams): Promise<Array<TextEdit>> {
    return this._sendRequest('textDocument/formatting', params);
  }

  async documentRangeFormatting(params: DocumentRangeFormattingParams): Promise<Array<TextEdit>> {
    return this._sendRequest('textDocument/rangeFormatting', params);
  }

  async documentOnTypeFormatting(params: DocumentOnTypeFormattingParams): Promise<Array<TextEdit>> {
  ...
  async _sendRequest(method: string, args?: Object): Promise<any> {
    this._log(`sendRequest ${method} sending`, args);
    try {
      const result = await this._con.sendRequest(method, args);
      this._log(`sendRequest ${method} received`, result);
      return result;
    } catch (e) {
      this._log(`sendRequest ${method} threw`, e);
      throw e;
    }
  }
}

...
export type ActiveServer = {
  ...
  // Ideally these would be elsewhere...
  filterableSuggestions?: Array<atom$AutocompleteSuggestion>,
  lastSuggestions?: Map<atom$AutocompleteSuggestion, [ls.CompletionItem, boolean]>,
};
